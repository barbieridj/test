...
<table markdown="block"><!--- Use HTML to create more complex tables. Note that markdown syntax has been enable in the table for convenience. If you prefer to use straight HTML, delete the markdown=" " attributes in the HTML tags below. Alternately, add the markdown="1" attribute if you want to enable markdown in a specific HTML tag. --->
  <thead>
    <tr>
      <th>Name</th>
      <th>Description</th>
